    ...
    def forward(self,
        ...
        for i in range(bs):
            ...
            if self.optimized_loss_calc:
                # below code is a performance optimization to the else statement flow
                # by using masks, we are achieving non-dynamic shapes and infer-able flow
                ...
                # in case of identical rejected/chosen - the mask will contain the last element in each sequence
