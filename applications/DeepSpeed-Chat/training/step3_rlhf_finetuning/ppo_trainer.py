    ...
    def _generate_sequence(self, prompts, mask, step):
        ...
        with torch.no_grad():
            ...
            if is_hpu():
                ...
                if self.use_cache and self.actor_model.module.config.model_type == "bloom" and self.args.enable_hybrid_engine:
                    print_rank_0("Deepspeed hybrid engine does not support cache for bloom model, disabling cache")
                ...
                if self.args.enable_hpu_graphs:
                    ...
                    # TODO (SW-171759) Remove the enforcement of graph recapture once HPU Graphs
                    # fully supports Zero3 under Hybrid Engine.
                    if self.z3_enabled and self.args.enable_hybrid_engine:
                        self.first_generate = True
                        self.actor_model_hpu_graph_wrapped_fwd_fn = None
            else:
