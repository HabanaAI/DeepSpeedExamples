...
from ..accelerator_utils import is_hpu
...
def create_critic_model(model_name_or_path,
    ...
    # TODO SW-172696: remove this WA once SW-172694 is resolved
    get_accelerator().synchronize()
    if is_hpu():
        critic_model.to(dtype=torch.bfloat16, device=get_accelerator().device_name())
