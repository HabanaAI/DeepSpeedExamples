...
# -----------------------------------------------------------------------
# RLHF step1 reference training script for LLaMAv2-7B model
# -----------------------------------------------------------------------
...
prefix_name=${tag}/llamav2-7b/step1
...
CMD="${training_dir}/step1_supervised_finetuning/main.py \
